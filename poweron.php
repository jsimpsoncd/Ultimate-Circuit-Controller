...
<table style="width:100%;border: 1px solid black;">
  ...
  <tr>
    ...
    <td><?php echo "<a href='".$url."?state=on&port=1'>Turn On</a></br><a href='".$url."?state=off&port=1'>Turn Off</a>";?></td>
  </tr>
  <tr>
    <td>Deck Floodlight</td>
    <td>2</td> 
    <td><?php echo explode(" ",$outletstats[1])[1];?></td>
    <td><?php echo "<a href='".$url."?state=on&port=2'><img src='./img/button_on_nact.png'></a></br><a href='".$url."?state=off&port=2'><img src='./img/button_off_nact.png'></a>";?></td>
  </tr>
  <tr>
    <td>Basement Lights</td>
    <td>3</td>
    <td><?php echo explode(" ",$outletstats[2])[1];?></td>
    <td><?php echo "<a href='".$url."?state=on&port=3'>Turn On</a></br><a href='".$url."?state=off&port=3'>Turn Off</a>";?></td>
  </tr>
</table>
</body>
</html>
